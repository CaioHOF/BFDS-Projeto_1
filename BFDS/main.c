...
void VenderCriptomoedas(CPointer pClients, int userIndex, MPointer pCriptos, EPointer ppExtrato){
    ...
    case 3: 
        ...
        if (valorVenda > pClients[userIndex].Ripple) {
            ...
            printf("pCriptos[2].Valor: %lf, pCriptos[2].TaxaVenda: %lf\n\n", pCriptos[2].Valor,pCriptos[2].TaxaVenda);
            printf("valorConvertido: %lf || Taxa: %lf || Valor final: %lf\n\n", valorConvertido, taxa, valorFinal);
